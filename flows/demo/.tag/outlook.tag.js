...
var flow_path = 'D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag';
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://outlook.live.com/'}); sleep(1000);
techo('https://outlook.live.com/' + ' - ' + chrome.getTitle());});

casper.then(function() {techo('wait 1s');});
casper.then(function() {casper.wait(1000, function() {});});

// 点击登录
casper.then(function() {{techo('click //*[@class="wf-menu"]//*[text()="登录"]');
casper.waitFor(function check() {return check_tx('//*[@class="wf-menu"]//*[text()="登录"]');},
function then() {chrome.click(tx('//*[@class="wf-menu"]//*[text()="登录"]'));},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //*[@class="wf-menu"]//*[text()="登录"]').exit(); this.wait(0);});}});

casper.then(function() {techo('wait 2s');});
casper.then(function() {casper.wait(2000, function() {});});

casper.then(function() {{techo('click 登录 Outlook');
casper.waitFor(function check() {return check_tx('登录 Outlook');},
function then() {chrome.click(tx('登录 Outlook'));},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find 登录 Outlook').exit(); this.wait(0);});}});

// 输入用户名
casper.then(function() {{techo('type //input as '+email_username+'');
casper.waitFor(function check() {return check_tx('//input');},
function then() {chrome.sendKeys(tx('//input'),''+email_username+'');},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //input').exit(); this.wait(0);});}});

// 点击下一个
casper.then(function() {{techo('click //*[text()="下一个"]');
casper.waitFor(function check() {return check_tx('//*[text()="下一个"]');},
function then() {chrome.click(tx('//*[text()="下一个"]'));},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //*[text()="下一个"]').exit(); this.wait(0);});}});

// 输入密码
casper.then(function() {{techo('type //input[@name="passwd"] as '+email_password+'');
casper.waitFor(function check() {return check_tx('//input[@name="passwd"]');},
function then() {chrome.sendKeys(tx('//input[@name="passwd"]'),''+email_password+'');},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //input[@name="passwd"]').exit(); this.wait(0);});}});

// 点击登录
casper.then(function() {{techo('click //*[text()="登录"]');
casper.waitFor(function check() {return check_tx('//*[text()="登录"]');},
function then() {chrome.click(tx('//*[text()="登录"]'));},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //*[text()="登录"]').exit(); this.wait(0);});}});

casper.then(function() {{techo('click //*[text()="否"]');
casper.waitFor(function check() {return check_tx('//*[text()="否"]');},
function then() {chrome.click(tx('//*[text()="否"]'));},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/demo/.tag/outlook_error.png');
this.echo('ERROR - cannot find //*[text()="否"]').exit(); this.wait(0);});}});
