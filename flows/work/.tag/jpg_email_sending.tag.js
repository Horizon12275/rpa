...
casper.then(function() {{techo('load ../.txt/jpg_body.txt to email_body');
var fs = require('fs'); email_body = '';
if (fs.exists('D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/../.txt/jpg_body.txt'))
email_body = fs.read('D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/../.txt/jpg_body.txt').trim();
else this.echo('ERROR - cannot find file ../.txt/jpg_body.txt').exit();}});
...
{sikuli_step('snap page.png to D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/jpg_email_sending_error.png');
...
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/jpg_email_sending_error.png');
...
// 上传附件
casper.then(function() {{techo('upload .O0 as '+email_attachment_1+'');
casper.waitFor(function check() {return check_tx('.O0');},
function then() {chrome.upload(tx('.O0'),''+abs_file(''+email_attachment_1+'')+'');},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/jpg_email_sending_error.png');
this.echo('ERROR - cannot find .O0').exit(); this.wait(0);});}});

casper.then(function() {{techo('upload .O0 as '+email_attachment_2+'');
casper.waitFor(function check() {return check_tx('.O0');},
function then() {chrome.upload(tx('.O0'),''+abs_file(''+email_attachment_2+'')+'');},
function timeout() {chrome.capture('D:/Horizon/Projects/Ongoing/rpa/flows/work/.tag/jpg_email_sending_error.png');
this.echo('ERROR - cannot find .O0').exit(); this.wait(0);});}});
